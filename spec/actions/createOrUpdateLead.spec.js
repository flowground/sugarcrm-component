describe('sugarCRM create or update leads', function () {
    var nock = require('nock');
    var action = require('../../lib/actions/createOrUpdateLead');
    ...
    it('should emit msg, snapshot, end events on success update request', function () {
        nock('https://test.com/')
            .post('/rest/v10/oauth2/token')
            .reply(200, {access_token: 1})
            .put('/rest/v10/Leads/c24c4069-7092-b95d-c040-523cc74a3d06')
            .reply(200, require('../data/list.out.json').records[0]);
