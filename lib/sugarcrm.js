...
function Service (config) {
    ...
    return {
         ...
         * @param snapshot - filter snapshot
         * @param emitter - eventEmitter for heartbeat
         * @returns {Promise}
         */
        getList: function (type, snapshot, emitter) {
            var defer = Q.defer();
            var results = [];
            var offset = 0;
